...
function makeReleaseFolder() {
  ...
  // FAIL-CLOSED (auditoria Fase 4, achado HIGH-2): a assinatura precisa ser
  // exatamente `<instalador>.sig`. Nunca se escolhe por data nem por
  // aproximacao -- ambiguidade e erro, nao heuristica.
